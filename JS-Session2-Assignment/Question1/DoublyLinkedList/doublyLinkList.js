/**Node class
 having three members data,previous and next part
...
function DoublyLinkList()
{
	...
	/**
		DoublyLinkList class function for adding new element in LinkedList
	*/
	...
	*/
	...
	this.traverseListInReverse=function(){
		if(arguments.length!=0)
		{
			console.log('Error: extra arguments passed');
			return;
	...
	*/
	this.searchFormValues=function(valueToSearch)
	{
		if(arguments.length!=1)
		{
			console.log('Error: extra arguments passed');
	...
	/**
		function for adding new value at user given position if exist
	*/
	...
	this.updateElementAt=function(position,elementData){
		...
		if( position>0&&position<=this.length&&('undefined'!=typeof elementData))
		{
			...
			*/
			...
			console.log('Element having value '+elementData+'  updated at position '+position);
...
var doublyObject=new DoublyLinkList();